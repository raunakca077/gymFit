      ...
      >
        ...
        >
          <Box as={Flex} flexDirection="column">
            ...
            <Text as={Link} to="/allproducts?gender=MEN">Weights Collection</Text>
            <Text as={Link} to="/allproducts?gender=WOMEN">Cardio Collection</Text>
            <Text as={Link} to="/allproducts?category=shoes" >Accessories Collection</Text>
            <Text as={Link} to="/allproducts?category=clothes">Merch Collection</Text>
          </Box>
          ...
          <Box mt="1rem" display={"flex"} gap="1rem" justifyContent={"center"}>
            <a
              href="https://www.linkedin.com/in/rnk22/"
              target={"_blank"}
              rel="noreferrer"
            >
            ...
            <a
              href="https://github.com/raunakca077"
              target={"_blank"}
              rel="noreferrer"
            >
